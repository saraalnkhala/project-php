...
$usersd = $database->prepare("INSERT INTO product(title,price,img) VALUES ('$title','$price','$floder')");
$usersd->execute(); 
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add_Proudect</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active"> Add_Proudect</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <form method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label >Name Prouduct </label>
                    <input  type="text" name="title" class="form-control" id="exampleInputEmail1" placeholder="Name Prouduct ">
                  </div>
                  ...
                  <div class="form-group">
                    <label >price</label>
                    <input ype="text" name="price" class="form-control" id="exampleInputPassword1" placeholder="price">
                  </div>
...
<li><a href="add.php" target="left"></a></li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020-2022 <a href="index.php">FootCap</a>.</strong>
    All rights reserved.
