...
<a name="vv" href="updat.php?id='.$row["id"].'" class=" btn btn-info"> <i class="fas fa-edit"></i></a>
<a href="delet.php?id='.$row["id"].'" class="btn btn-danger">  <i class="fas fa-trash-alt"></i> </a>
</td>
</tr>';
}
}
...
{
    $id=$_GET["id"];
    $con= new mysqli("localhost","root","","myproject",3306);
