          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">products Store </h3>
...
<td><img src="'.$row["img"].'" alt="" width="100" height="100"></td>
<td>'.$row["price"].'</td>
<td>

<a name="vv" href="update.php?id='.$row["id"].'" class=" btn btn-info"> <i class="fas fa-edit"></i></a>
